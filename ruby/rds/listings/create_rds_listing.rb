...
client.call_api :post, '/api/v1/developer/rds/rds_listings', {
  ...
  images: [{ thumb: 'http://s3.amazonaws.com/rvx-rds-dev/development/images/uploads/007/980/533/thumb/open-uri20180720-42837-1ph9d9j.png?1532132627',
  ...
  rds_sellers: [{ name: 'Zappos Retail, Inc.', min_price: 46.74, max_price: 46.74 },
